...
def end_of_round(self, last_game_state: dict, last_action: str, events: List[str]):
    ...
    with open("current_round.pt", "wb") as file:
        pickle.dump(self.current_round, file)
...
def feature_augmentation(self, aug_direction, first_state, last_state, action, disc, n_future_rew, n):
    ...
    model_update = self.model[shift_action] + self.learning_rate * GRADIENT   # updating the model for the relevant action
